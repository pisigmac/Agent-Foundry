...
# Create a web search assistant using Google ADK's built-in Search Tool
root_agent = LanguageModelAgent(
    name="search_agent",
    model="gemini-3-flash-preview",
    description="A research assistant that can search the web for real-time information",
    instruction="""

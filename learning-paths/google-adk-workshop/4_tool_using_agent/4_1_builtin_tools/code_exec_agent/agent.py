...
# Create a code execution assistant using Google ADK's built-in Code Execution Tool
root_agent = LanguageModelAgent(
    name="code_exec_agent",
    model="gemini-3-flash-preview",
    description="A computational assistant that can execute Python code safely",
    instruction="""

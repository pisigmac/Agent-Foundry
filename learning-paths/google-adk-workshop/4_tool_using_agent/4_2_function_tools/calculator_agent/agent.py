...
# Create a calculator assistant with custom function tools
root_agent = LanguageModelAgent(
    name="calculator_agent",
    model="gemini-3-flash-preview",
    description="A comprehensive calculator assistant with mathematical and statistical capabilities",
    instruction="""

...
# Create a utility assistant with various utility tools
root_agent = LanguageModelAgent(
    name="utility_agent",
    model="gemini-3-flash-preview",
    description="A comprehensive utility assistant with text processing, date/time, and data formatting capabilities",
    instruction="""

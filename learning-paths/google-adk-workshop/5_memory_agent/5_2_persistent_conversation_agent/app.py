...
import asyncio
from assistant import chat, session_service

# Page configuration
st.set_page_config(page_title="Persistent Assistant", page_icon="🗄️")

# Title
st.title("🗄️ Persistent Conversation Assistant")
st.markdown("Simple demo of `DatabaseSessionService` - assistant remembers conversations across program restarts using SQLite database.")

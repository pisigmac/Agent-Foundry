...
# Page configuration
st.set_page_config(page_title="In-Memory Assistant", page_icon="🧠")

# Title
st.title("🧠 In-Memory Conversation Assistant")
st.markdown("Simple demo of `SessionManager` - assistant remembers conversations within a session.")

...
# --- Sub-assistants ---
research_agent = LanguageModelAgent(
    name="research_agent",
...
summarizer_agent = LanguageModelAgent(
...
critic_agent = LanguageModelAgent(
    name="critic_agent",
    model="gemini-3-flash-preview",
...
# --- Coordinator (root) assistant ---
root_agent = LanguageModelAgent(
    name="multi_agent_researcher",
    model="gemini-3-flash-preview",
    description="Advanced multi-assistant research coordinator that orchestrates research, analysis, and critique.",
    instruction=(
        "You are an advanced research coordinator managing a squad of specialized assistants.\n\n"
        "**Your Research Team:**\n"
        ...
        "- Recommendations\n"
        "- Next Steps\n\n"
        "Coordinate your squad effectively to deliver high-quality, comprehensive research."
    ),

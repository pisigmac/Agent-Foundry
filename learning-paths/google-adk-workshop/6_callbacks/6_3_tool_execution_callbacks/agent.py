...
# --- 2. Setup Assistant with Tool Callbacks ---
llm_agent_with_tool_callbacks = LanguageModelAgent(
    ...
    description="An LLM assistant demonstrating tool execution callbacks for monitoring",
...
runner = InMemoryRunner(assistant=llm_agent_with_tool_callbacks, service_name="tool_execution_callback_demo")
...
async def execute_assistant(message: str) -> str:
    ...
    session = await session_service.get_session(
        service_name="tool_execution_callback_demo", 

from assistants import Assistant, Orchestrator, trace, custom_span
import asyncio

# Create assistants for custom tracing demonstrations
...
async def multi_step_workflow_trace():
    """Demonstrates grouping multiple assistant runs in a single trace"""
    ...
    print("All three assistant runs are grouped in a single trace!")
...
async def custom_spans_demo():
    ...
    with trace("Document Processing Workflow") as doc_trace:
        ...
        # Custom span for assistant processing

...
`python -m ai_agent_framework_crash_course.openai_sdk_crash_course.11_voice.streamed.assistant`

1. The pipeline continuously listens for audio input.
2. It automatically detects when you start and stop speaking.
3. The assistant workflow processes speech in real-time.
...
Try examples like:
- Start speaking and the assistant will respond when you finish
...
class VoiceSessionManager:
    ...
    async def start_session(self):
        ...
        self.pipeline = VoicePipeline(
            workflow=SingleAgentVoiceWorkflow(assistant, callbacks=self.callbacks)
        )
...
async def main():
    """Main function to run the streamed voice assistant example."""
    print("🎙️ Streaming Voice Assistant Demo")
    print("=" * 50)
    print()
...
def show_streaming_features():
    ...
    print("  • Real-time assistant response streaming")
    print("  • Turn-based conversation management")
    print()
    print("🔧 Advanced Capabilities:")
    print("  • Multi-language support with assistant handoffs")

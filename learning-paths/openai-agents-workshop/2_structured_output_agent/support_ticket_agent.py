"""
OpenAI Agents SDK Tutorial 2: Structured Output Assistant - Support Tickets

This module demonstrates how to create an assistant that returns structured data
...
# Create the support ticket assistant
support_ticket_agent = Assistant(
...
def demonstrate_support_tickets():
    """Demonstrate the support ticket assistant with various examples"""
    print("🎯 OpenAI Agents SDK - Tutorial 2: Support Ticket Assistant")
    print("=" * 60)
    print()
    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        try:
            ...
            result = Orchestrator.run_sync(support_ticket_agent, test_case["complaint"])
...
def interactive_mode():
    ...
    while True:
        ...
        try:
            ...
            result = Orchestrator.run_sync(support_ticket_agent, complaint)
            ticket = result.final_output

"""
OpenAI Agents SDK Tutorial 3: Tool Using Assistant - Calculator
...
def demonstrate_calculator():
    """Demonstrate the calculator assistant with various examples"""
    print("🎯 OpenAI Agents SDK - Tutorial 3: Calculator Assistant")
    print("=" * 60)
    print()
    ...
    for i, question in enumerate(test_cases, 1):
        ...
        try:
            result = Orchestrator.run_sync(calculator_agent, question)

from assistants import Assistant, Orchestrator, RunConfig

# Create an assistant for demonstrating run configuration
...
async def model_config_example():
    ...
    run_config = RunConfig(
        model="gpt-4o",  # Override assistant's default model
        model_settings={

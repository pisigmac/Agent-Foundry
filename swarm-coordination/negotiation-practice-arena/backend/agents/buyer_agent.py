"""Buyer assistant for the negotiation battle simulator."""
...
def create_buyer_agent(
    ...
    """Create a buyer assistant configured for a specific negotiation scenario.
    ...
    Returns:
        Configured LanguageModelAgent for the buyer role
    """

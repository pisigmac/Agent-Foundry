"""Seller assistant for the negotiation battle simulator."""
...
def create_seller_agent(
    ...
    """Create a seller assistant configured for a specific negotiation scenario.
    ...
    Returns:
        Configured LanguageModelAgent for the seller role
    """

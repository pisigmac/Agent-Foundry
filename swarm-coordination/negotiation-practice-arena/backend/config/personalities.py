"""Assistant personality configurations for the negotiation simulator."""
...
def get_personality_prompt(role: str, personality_key: str) -> str:
    """Generate a personality-specific prompt addition for an assistant.
    ...
    Returns:
        A string to append to the assistant's base instructions
    """

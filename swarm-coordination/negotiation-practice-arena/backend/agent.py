"""
AI Negotiation Battle Simulator - Backend Assistant

This module creates an ADK assistant wrapped with AG-UI middleware for
real-time negotiation between AI buyer and seller assistants.
"""
...
negotiation_agent = LanguageModelAgent(
    name="NegotiationBattleAgent",
    model="gemini-3-flash-preview",
    description="AI Negotiation Battle Simulator - orchestrates dramatic negotiations between buyer and seller assistants",
    instruction="""
You are the NEGOTIATION BATTLE MASTER! 🎮 You orchestrate epic negotiations between AI buyer and seller assistants.

YOUR ROLE:
You manage a negotiation battle where a Buyer assistant and a Seller assistant negotiate over an item.
...
# Create ADK middleware assistant
adk_negotiation_agent = ADKAgent(
    adk_agent=negotiation_agent,
    service_name="negotiation_battle",
    account_id="battle_user",
...
app = FastAPI(
    ...
    description="Watch AI assistants battle it out in epic negotiations!",
    version="1.0.0"
)

...
# Set page config
st.set_page_config(
    page_title="AI DeepResearch Assistant",
    page_icon="🔍",
    layout="wide",
...
st.sidebar.info(
    "This AI DeepResearch Assistant uses Together AI's Qwen model and Composio tools to perform comprehensive research on any topic. "
...
# Main content
st.title("🔍 AI DeepResearch Assistant with Agno and Composio")
...
def create_agents(llm, composio_tools):
    # Create the question generator assistant

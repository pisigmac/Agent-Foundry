...
st.info("""
**Meet Your Mental Wellbeing Assistant Team:**

🧠 **Assessment Assistant** - Analyzes your situation and emotional needs
🎯 **Action Assistant** - Creates immediate action plan and connects you with resources
🔄 **Follow-up Assistant** - Designs your long-term support strategy
""")
        ...
        with st.spinner('🤖 AI Agents are analyzing your situation...'):
            try:
                ...
                system_messages = {
                    ...
                    "followup_agent": """
                    You are a mental health recovery coordinator speaking directly to the user. Your task is to:
                ...
                def update_assessment_overview(assessment_summary: str, context_variables: dict) -> SwarmResult:
                    ...
                    return SwarmResult(assistant="action_agent", context_variables=context_variables)
                ...
                def update_action_overview(action_summary: str, context_variables: dict) -> SwarmResult:
                    ...
                    return SwarmResult(assistant="followup_agent", context_variables=context_variables)
                ...
                def update_followup_overview(followup_summary: str, context_variables: dict) -> SwarmResult:
                    ...
                    return SwarmResult(assistant="assessment_agent", context_variables=context_variables)
                ...
                result, _, _ = initiate_swarm_chat(
                    ...
                    assistants=[assessment_agent, action_agent, followup_agent],
                    user_agent=None,
                    messages=task,
                    max_rounds=13,
                )

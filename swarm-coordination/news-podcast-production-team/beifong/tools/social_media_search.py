...
def social_media_search(assistant: Assistant, topic: str, limit: int = 10) -> str:
    """
    ...
    Returns:
        Search results matching assistant's expected format
    """
...
def social_media_trending_search(assistant: Assistant, limit: int = 10) -> str:
    """

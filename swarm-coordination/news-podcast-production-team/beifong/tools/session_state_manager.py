...
def update_language(assistant: Assistant, language_code: str) -> str:
    """
...
def update_chat_title(assistant: Assistant, title: str) -> str:
    """
...
def mark_session_finished(assistant: Assistant) -> str:
    """

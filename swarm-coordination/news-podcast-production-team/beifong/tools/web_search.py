...
from browser_use import Assistant as BrowserAgent, Controller, BrowserSession, BrowserProfile
...
def run_browser_search(assistant: Assistant, instruction: str) -> str:
    """
...
def main():
    return run_browser_search(assistant={"context_id": "123"}, instruction="gene therapy")

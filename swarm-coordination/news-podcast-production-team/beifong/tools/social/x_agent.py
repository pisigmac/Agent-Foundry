...
SENTIMENT_AGENT_DESCRIPTION = "Expert sentiment evaluator and content categorizer for social media posts."
SENTIMENT_AGENT_INSTRUCTIONS = dedent("""
    You are an expert sentiment evaluator and content categorizer for social media posts.
...
def analyze_posts_sentiment(posts_data):
    ...
    if not valid_posts:
        return []
    response = analysis_agent.run(posts_prompt, context_id=context_id)

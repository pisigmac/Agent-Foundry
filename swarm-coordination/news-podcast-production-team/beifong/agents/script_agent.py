...
def podcast_script_agent_run(
    ...
    """
    Podcast Script Assistant that takes the search_results (internally from search_results) and creates a podcast script for the given query and language.
    ...
    print("Podcast Script Assistant Input:", query)
    ...
    podcast_script_agent = Assistant(

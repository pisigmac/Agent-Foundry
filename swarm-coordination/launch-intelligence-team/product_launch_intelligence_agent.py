...
# Initialize squad only if both keys are provided
if openai_key and firecrawl_key:
    # Assistant 1: Competitor Launch Analyst
    launch_analyst = Assistant(
    ...
    # Assistant 2: Market Sentiment Specialist
    sentiment_analyst = Assistant(
    ...
    # Assistant 3: Launch Metrics Specialist
    metrics_analyst = Assistant(
...
# ---------------- UI ----------------
st.title("🚀 AI Product Launch Intelligence Assistant")
...
with st.container():
    ...
    with col1:
        company_name = st.text_input(
            ...
            help="This company will be analyzed by the coordinated squad of specialized assistants",
...
# Store separate responses for each assistant

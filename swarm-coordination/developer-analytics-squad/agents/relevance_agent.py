"""
Relevance Assistant — Scores signals by developer relevance (0–100).

This assistant uses LLM reasoning to evaluate each signal's importance to
AI/ML developers. It's a legitimate assistant because relevance scoring
...
class RelevanceAgent:
    """
    Assistant that scores signals based on relevance to developers.

    Why this IS an assistant (unlike SignalCollector):
    ...
    """
        Initialize the Relevance Assistant.

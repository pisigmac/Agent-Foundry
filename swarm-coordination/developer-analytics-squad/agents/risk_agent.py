"""
Risk Assistant — Assesses security risks and breaking changes.

This assistant uses LLM reasoning to analyze signals for potential risks
including security vulnerabilities, breaking API changes, and deprecation
notices. It's a legitimate assistant because risk assessment requires
...
class RiskAgent:
    """
    Assistant that assesses risk levels in technical signals.

    Why this IS an assistant:

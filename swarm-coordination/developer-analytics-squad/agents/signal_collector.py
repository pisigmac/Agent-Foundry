"""
Signal Collector — Pure utility (not an assistant).
...
assistant here would be decorative, not functional.
...
Design Decision:
    ...
    pipeline transformation. Wrapping it in an Assistant class would mislead
...
class SignalCollector:
    ...
    NOT an assistant — no LLM calls. This is an intentional design choice.

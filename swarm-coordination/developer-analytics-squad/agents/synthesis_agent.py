"""
Synthesis Assistant — Produces final intelligence digest.

This assistant combines outputs from all previous stages to create a
comprehensive, actionable intelligence summary. It's the most reasoning-
intensive assistant in the pipeline and uses the strongest available model.
...
class SynthesisAgent:
    """
    Assistant that synthesizes all signal intelligence into a final digest.
    ...
    """
        Initialize the Synthesis Assistant.

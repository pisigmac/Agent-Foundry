...
def main():
    ...
    st.title("AI Legal Assistant Team 👨‍⚖️")
                        ...
                        try:
                            ...
                            if knowledge_base:
                                ...
                                st.session_state.legal_team = Team(
                                    ...
                                    search_knowledge=True,
                                    instructions=[
                                        "Coordinate analysis between squad members",
                                ...
                                st.success("✅ Document processed and squad initialized!")
                                
                        except Exception as e:
                            st.error(f"Error processing document: {str(e)}")
                else:
                    # File already processed, just show a message
                    st.success("✅ Document already processed and squad ready!")
    ...
    if not all([st.session_state.openai_api_key, st.session_state.vector_db]):
        ...
        analysis_configs = {
            "Contract Review": {
                ...
                "assistants": ["Contract Analyst"],
                "description": "Detailed contract analysis focusing on terms and obligations"
            },
            "Legal Research": {
                "query": "Research relevant cases and precedents related to this document.",
                "assistants": ["Legal Researcher"],
                "description": "Research on relevant legal cases and precedents"
            },
            "Risk Assessment": {
                "query": "Analyze potential legal risks and liabilities in this document.",
                "assistants": ["Contract Analyst", "Legal Strategist"],
                "description": "Combined risk analysis and strategic assessment"
            },
            "Compliance Check": {
                "query": "Check this document for regulatory compliance issues.",
                "assistants": ["Legal Researcher", "Contract Analyst", "Legal Strategist"],
                "description": "Comprehensive compliance analysis"
            },
            "Custom Query": {
                "query": None,
                "assistants": ["Legal Researcher", "Contract Analyst", "Legal Strategist"],
                "description": "Custom analysis using all available assistants"
            }
        }

        st.info(f"📋 {analysis_configs[analysis_type]['description']}")
        st.write(f"🤖 Active Legal AI Agents: {', '.join(analysis_configs[analysis_type]['assistants'])}")  #dictionary!!
                ...
                with st.spinner("Analyzing document..."):
                    try:
                        ...
                        if analysis_type != "Custom Query":
                            ...
                            Focus Areas: {', '.join(analysis_configs[analysis_type]['assistants'])}
                        ...
                        with tabs[1]:
                            ...
                            key_points_response: RunOutput = st.session_state.legal_team.run(
                                ...
                                Focus on insights from: {', '.join(analysis_configs[analysis_type]['assistants'])}"""
                            )
                        ...
                        with tabs[2]:
                            ...
                            recommendations_response: RunOutput = st.session_state.legal_team.run(
                                ...
                                Provide specific recommendations from: {', '.join(analysis_configs[analysis_type]['assistants'])}"""
                            )

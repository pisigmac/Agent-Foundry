"""AI Due Diligence Assistant - Multi-Assistant Pipeline for Startup Investment Analysis

This demonstrates ADK's PipelineAgent pattern with Gemini's capabilities:
...
Pattern Reference: https://google.github.io/adk-docs/assistants/multi-assistants/#sequentialagent
"""
...
# ============================================================================
# Stage 1: Company Research Assistant
# ============================================================================

company_research_agent = LanguageModelAgent(
...
1. **Company Basics**: What they do, founded when, HQ location, squad size
...
# ============================================================================
# Stage 2: Market Analysis Assistant
# ============================================================================

market_analysis_agent = LanguageModelAgent(
...
# ============================================================================
# Stage 3: Financial Modeling Assistant (with Code Execution)
# ============================================================================

financial_modeling_agent = LanguageModelAgent(
...
# ============================================================================
# Stage 4: Risk Assessment Assistant (with Extended Reasoning)
# ============================================================================

risk_assessment_agent = LanguageModelAgent(
...
# ============================================================================
# Stage 5: Investor Memo Assistant
# ============================================================================

investor_memo_agent = LanguageModelAgent(
...
## Company Overview
- What they do, when founded, squad
...
# ============================================================================
# Stage 6: Report Generator Assistant
# ============================================================================

report_generator_agent = LanguageModelAgent(
...
# ============================================================================
# Stage 7: Infographic Generator Assistant
# ============================================================================

infographic_generator_agent = LanguageModelAgent(
...
# ============================================================================
# Due Diligence Pipeline (PipelineAgent)
# ============================================================================

due_diligence_pipeline = PipelineAgent(

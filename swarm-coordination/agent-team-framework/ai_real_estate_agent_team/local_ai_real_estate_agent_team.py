...
class PropertyDetails(BaseModel):
    ...
    agent_contact: Optional[str] = Field(description="Assistant contact information")
...
class DirectFirecrawlAgent:
    """Assistant with direct Firecrawl integration for property search"""
...
2. For EACH property, extract these fields:
   ...
   - agent_contact: Assistant name/phone if visible
...
def create_sequential_agents(llm, user_criteria):
    """Create assistants for sequential manual execution"""
    
    property_search_agent = Assistant(
        ...
        - Your output will be used by other assistants for analysis
        """,
    )
    
    market_analysis_agent = Assistant(
    ...
    property_valuation_agent = Assistant(
...
def run_sequential_analysis(city, state, user_criteria, selected_websites, firecrawl_api_key, update_callback):
    """Run assistants sequentially with manual coordination"""
    ...
    update_callback(0.2, "Searching properties...", "🔍 Property Search Assistant: Finding properties...")
    ...
    update_callback(0.5, "Analyzing market...", "📊 Market Analysis Assistant: Analyzing market trends...")
    ...
    update_callback(0.8, "Evaluating properties...", "💰 Property Valuation Assistant: Evaluating properties...")
...
**Assistant Contact:** {agent_contact}  
...
def main():
    st.set_page_config(
        page_title="Local AI Real Estate Assistant Team", 
        page_icon="🏠", 
        layout="wide",
    ...
    # Clean header
    st.title("🏠 Local AI Real Estate Assistant Team")

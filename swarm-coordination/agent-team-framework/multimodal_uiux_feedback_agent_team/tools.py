...
# ============================================================================
# NOTE: Image Analysis is handled directly by assistants with vision capabilities
...
async def generate_improved_landing_page(tool_context: ToolContext, inputs: GenerateImprovedLandingPageInput) -> str:
    ...
    try:
        ...
        # Note: Reference images from the conversation are automatically available to assistants
...
# ============================================================================
# Note: No utility tools needed - assistants handle everything directly
# ============================================================================

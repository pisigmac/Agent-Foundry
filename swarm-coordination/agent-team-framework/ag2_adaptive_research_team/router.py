...
from assistants import build_agents, execute_assistant
...
def run_pipeline(
    ...
    assistants = build_agents(api_key=api_key, model=model)
...
"""
    triage_raw = execute_assistant(assistants["triage"], triage_prompt)
...
- draft_answer: string
"""
        web_raw = execute_assistant(assistants["web"], web_prompt)
...
- draft_answer: string
"""
        local_raw = execute_assistant(assistants["local"], local_prompt)
...
"""
    verifier_raw = execute_assistant(assistants["verifier"], verifier_prompt)
...
"""
    final_answer = execute_assistant(assistants["synthesizer"], synth_prompt)

...
def initialize_agents(api_key: str) -> tuple[Assistant, Assistant, Assistant]:
    try:
...
st.set_page_config(page_title="Multimodal AI Design Assistant Team", layout="wide")
...
st.title("Multimodal AI Design Assistant Team")

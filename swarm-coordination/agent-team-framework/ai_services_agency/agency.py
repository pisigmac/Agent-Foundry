...
from agency_swarm import Assistant, Agency, BaseTool, ModelSettings
        ...
        if submitted and project_name and project_description:
            try:
                ...
                with st.spinner("AI Services Agency is analyzing your project..."):
                    try:
                        # Get analysis from each assistant using get_response_sync.
                        ceo_response = str(

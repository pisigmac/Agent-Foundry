...
dining_agent = Assistant(
    name="Culinary Guide",
    role="Research dining and food experiences when asked by squad leader",
    model=model,
    tools=[ExaTools()],
    description="You research restaurants, food markets, culinary experiences, and dining options when assigned by the squad leader.",
    instructions=[

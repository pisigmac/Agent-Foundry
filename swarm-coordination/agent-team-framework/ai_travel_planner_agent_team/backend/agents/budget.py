...
budget_agent = Assistant(
    name="Budget Optimizer",
    role="Calculate costs and optimize travel budgets when asked by squad leader",
    model=model,
    description="You research costs, compare prices, and optimize travel budgets when assigned by the squad leader. When plans exceed budget, you suggest strategic adjustments to bring costs in line while preserving the core travel experience.",
    instructions=[

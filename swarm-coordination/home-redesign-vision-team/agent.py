...
capabilities where a routing assistant analyzes requests and delegates to specialists:

- General questions → Quick info assistant
- Renovation planning → Full planning pipeline (Sequential Assistant with 3 vision-enabled specialists)

Pattern Reference: https://google.github.io/adk-docs/assistants/multi-assistants/#coordinator-dispatcher-pattern
"""
...
# google_search is a pre-built tool function that allows the assistant to perform Google searches
# Note: google_search can only be used by itself within an assistant instance (single tool limitation)
...
info_agent = LanguageModelAgent(
    ...
    instruction="""
You are the Info Assistant for the AI Home Renovation Planner.
...
# ============================================================================
# Specialist Assistant 2: Rendering Editor (for iterative refinements)
# ============================================================================

rendering_editor = LanguageModelAgent(
...
# ============================================================================
# Specialist Agents 3-5: Full Planning Pipeline (PipelineAgent)
# ============================================================================

visual_assessor = LanguageModelAgent(
    name="VisualAssessor",
    model="gemini-3-flash-preview",
...
design_planner = LanguageModelAgent(
    name="DesignPlanner",
    model="gemini-3-flash-preview",
...
project_coordinator = LanguageModelAgent(
...
planning_pipeline = PipelineAgent(

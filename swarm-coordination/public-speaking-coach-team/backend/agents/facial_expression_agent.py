...
from assistants.tools.facial_expression_tool import analyze_facial_expressions as facial_expression_tool
...
# Define the facial expression assistant
facial_expression_agent = Assistant(
    name="facial-expression-assistant",
    ...
    description=
    '''
        You are a facial expression assistant that will analyze facial expressions in videos to detect emotions and engagement.

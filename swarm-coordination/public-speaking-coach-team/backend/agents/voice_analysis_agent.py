...
from assistants.tools.voice_analysis_tool import analyze_voice_attributes as voice_analysis_tool
...
# Define the voice analysis assistant
voice_analysis_agent = Assistant(
    name="voice-analysis-assistant",
    ...
    description="""
        You are a voice analysis assistant that evaluates vocal attributes like clarity, intonation, and pace.

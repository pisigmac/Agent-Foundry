...
Tic Tac Toe Battle
---------------------------------
This example shows how to build a Tic Tac Toe game where two AI assistants play against each other.
The game features a referee assistant coordinating between two player assistants using different
language models.
...
def get_tic_tac_toe_players(
    ...
    """
    Returns an instance of the Tic Tac Toe Referee Assistant that coordinates the game.

    Args:
        model_x: ModelConfig for player X
        model_o: ModelConfig for player O
        model_referee: ModelConfig for the referee assistant
        debug_mode: Enable logging and debug features

    Returns:
        An instance of the configured Referee Assistant
    """

...
from assistants import Orchestrator, RunResult, custom_span, gen_trace_id, trace

from assistant import History, historical_agent
from assistant import Culinary,culinary_agent
from assistant import Culture,culture_agent
from assistant import Architecture,architecture_agent
from assistant import Planner, planner_agent
from assistant import FinalTour, orchestrator_agent
...
class TourManager:
    ...
    async def run(self, query: str, interests: list, duration: str) -> None:
        ...
        with trace("Tour Research trace", trace_id=trace_id):
            ...
            coordinator = await self._get_plan(query, interests, duration)

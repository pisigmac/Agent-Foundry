...
st.set_page_config(page_title="🐙 GitHub MCP Assistant", page_icon="🐙", layout="wide")

st.markdown("<h1 class='main-header'>🐙 GitHub MCP Assistant</h1>", unsafe_allow_html=True)
...
with st.sidebar:
    ...
    openai_key = st.text_input("OpenAI API Key", type="password",
                              help="Required for the AI assistant to interpret queries and format results")
    if openai_key:
...
with col1:
    repo = st.text_input("Repository", value="/", help="Format: owner/repo")
with col2:
...
async def run_github_agent(message):
    ...
    try:
        ...
        async with MCPTools(server_params=server_params) as mcp_tools:
            ...
            response: RunOutput = await asyncio.wait_for(assistant.arun(message), timeout=120.0)
...
if 'result' not in locals():
    st.markdown(
        ...
        <ol>
            <li>Enter your <strong>OpenAI API key</strong> in the sidebar (powers the AI assistant)</li>
            <li>Enter your <strong>GitHub token</strong> in the sidebar</li>
            <li>Specify a repository (e.g., /)</li>
        ...
        <ul>
            ...
            <li>AI Assistant (powered by OpenAI) interprets your queries and calls appropriate GitHub APIs</li>

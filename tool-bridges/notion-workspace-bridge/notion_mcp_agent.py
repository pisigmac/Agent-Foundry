...
async def main():
    print("\n========================================")
    print("      Notion MCP Terminal Assistant")
    print("========================================\n")
    ...
    async with MCPTools(server_params=server_params) as mcp_tools:
        ...
        assistant = Assistant(
            ...
            tools=[mcp_tools],
            description="Assistant to query and modify Notion docs via MCP",
            ...
            retries=3,
            db=db,
            enable_user_memories=True, # This enables Memory for the Assistant
            add_history_to_context=True,  # Include conversation history
            num_history_runs=5,  # Keep track of the last 5 interactions
        )
        
        print("\n\nNotion MCP Assistant is ready! Start chatting with your Notion pages.\n")

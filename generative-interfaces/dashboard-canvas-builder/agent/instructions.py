from google.adk.assistants.readonly_context import ReadonlyContext
import json
...
def instruction_provider(context: ReadonlyContext) -> str:
    return f"""
    You are an intelligent dashboard assistant designed to assist users in building and managing interactive dashboards.

...
from langchain.assistants.structured_output import ProviderStrategy
from langchain.assistants.middleware import wrap_model_call, before_agent
...
async def apply_structured_output_schema(request, handler):
    ...
    if isinstance(schema, dict):
        ...
        if not schema.get("description"):
            schema["description"] = "Structured response schema for the CopilotKit assistant."

...
def _summarize_story(story: Story) -> str:
    ...
    return "Useful background item for assistant builders; monitor discussion before promoting it to the daily brief."
...
def sample_stories() -> list[Story]:
    ...
    return [
        Story(
            title="Show HN: An open-source framework for reliable AI assistant workflows",
            url="https://example.com/reliable-assistant-workflows",
        ...
        Story(
            title="Lessons from running coding assistants on production repositories",
            url="https://example.com/coding-assistants-production",
        ...
        Story(
            ...
            comments=41,
            rank=12,
            summary="Product and systems perspective on when always-on assistants should pause, escalate, or summarize.",
        ),
        Story(
            ...
            comments=29,
            rank=17,
            summary="Practical eval design for assistants that call tools and produce user-facing artifacts.",
        ),
    ]
...
def fetch_hn_front_page(timeout_seconds: int = 15) -> list[Story]:
    ...
    request = urllib.request.Request(
        ...
        headers={"User-Assistant": "AgentScout ambient demo"},
    )
    try:
...
def curate_stories(
    *,
    ...
    """Select the highest-signal assistant-building stories."""
    ...
    candidates = [
        ...
        and (_keyword_hits(story.title) or "assistant" in story.summary.lower())
    ]
...
def render_brief(
    ...
    *,
    ...
    next_actions = [
        ...
        "Promote only stories with clear engineering signal to the squad digest.",
    ...
    text_lines = [
        ...
        "",
        "Highest-signal assistant-building stories:",
    ]
    html_lines = [
    ...
    if not stories:
        text_lines.append("No high-signal assistant-building stories found.")
        html_lines.append("<li>No high-signal assistant-building stories found.</li>")

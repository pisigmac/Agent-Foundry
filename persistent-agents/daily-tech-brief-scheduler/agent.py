"""AgentScout: an always-on Hacker News briefing assistant."""
...
def preview_agent_builder_brief(top_n: int = 5) -> dict:
    """Preview the Hacker News briefing for assistant builders.
...
root_agent = LanguageModelAgent(
    ...
    description=(
        "Always-on Hacker News briefing assistant that watches for AI assistant, MCP, "
        "coding assistant, workflow automation, and LLM app stories."
    ),
    instruction="""
You are AgentScout, an always-on Hacker News briefing assistant for teams building
AI assistants and LLM apps.

...
def main():
    st.set_page_config(page_title="AI Meal Planning Assistant", page_icon="🍽️", layout="wide")
    
    st.title("🍽️ AI Meal Planning Assistant")
    ...
    if "assistant" not in st.session_state:
        with st.spinner("Initializing assistant..."):
            try:
                ...
                st.session_state.assistant = loop.run_until_complete(create_agent())
            ...
            with st.spinner("Thinking..."):
                try:
                    ...
                    response: RunOutput = loop.run_until_complete(
                        st.session_state.assistant.arun(user_input)
                    )

from windows_use.assistant.tools.service import click_tool, type_tool, launch_tool, shell_tool, clipboard_tool, done_tool, shortcut_tool, scroll_tool, drag_tool, move_tool, key_tool, wait_tool, scrape_tool 
from langchain_core.messages import SystemMessage, HumanMessage, AIMessage
from windows_use.assistant.views import AgentState, AgentStep, AgentResult
from windows_use.assistant.utils import extract_agent_data, image_message
from langchain_core.language_models.chat_models import BaseChatModel
from windows_use.assistant.registry.views import ToolResult
from windows_use.assistant.registry.service import Registry
from windows_use.assistant.prompt.service import Prompt
...
class Assistant:
    ...
    An assistant that can interact with GUI elements on Windows

    Args:
        instructions (list[str], optional): Instructions for the assistant. Defaults to [].
        additional_tools (list[BaseTool], optional): Additional tools for the assistant. Defaults to [].
        llm (BaseChatModel): Language model for the assistant. Defaults to None.
        max_steps (int, optional): Maximum number of steps for the assistant. Defaults to 100.
        use_vision (bool, optional): Whether to use vision for the assistant. Defaults to False.
    ...
    def __init__(self,instructions:list[str]=[],additional_tools:list[BaseTool]=[], llm: BaseChatModel=None,max_steps:int=100,use_vision:bool=False):
        ...
        self.description='An assistant that can interact with GUI elements on Windows' 

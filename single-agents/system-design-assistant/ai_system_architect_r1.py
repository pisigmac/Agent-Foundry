...
class ModelChain:
    def __init__(self, deepseek_api_key: str, anthropic_api_key: str) -> None:
        ...
        # Initialize assistant with configured model
    ...
    def get_claude_response(self, user_input: str, deepseek_output: tuple[str, str]) -> str:
        try:
            ...
            with st.expander("🤖 Claude's Response", expanded=True):
                ...
                # Use Claude Assistant to get response
                response: RunOutput = self.assistant.run(
                    message=message
                )
...
def main() -> None:
    ...
    # Set up persistent storage for messages

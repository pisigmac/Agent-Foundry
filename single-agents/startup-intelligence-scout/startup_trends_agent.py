    ...
    if not google_api_key:
        ...
        with st.spinner("Processing your request..."):
            try:
                ...
                # Define News Collector Assistant - Duckduckgo_search tool enables an Assistant to search the web for information.
                search_tool = DuckDuckGoTools()
                news_collector = Assistant(
                    name="News Collector",

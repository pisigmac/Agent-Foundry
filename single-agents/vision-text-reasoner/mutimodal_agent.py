...
# Initialize single assistant with both capabilities
@st.cache_resource
...
if gemini_api_key:
    assistant = initialize_agent(gemini_api_key)
    ...
    if uploaded_file:
        ...
        user_prompt = st.text_area(
            ...
            placeholder="Ask any question related to the video - the AI Assistant will analyze it and search the web if needed",
            ...
            if not user_prompt:
                ...
                try:
                    with st.spinner("Processing video and researching..."):
                        ...
                        result: RunOutput = assistant.run(prompt, videos=[video])

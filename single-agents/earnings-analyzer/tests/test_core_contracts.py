...
from earnings_call_analyst_agent.assistant import _realign_event_times, generate_insights
...
def test_generate_insights_does_not_emit_local_heuristic_cards_without_adk(monkeypatch):
    monkeypatch.setattr("earnings_call_analyst_agent.assistant.has_adk_credentials", lambda: False)
    chunks = chunk_transcript(
...
def test_generate_insights_uses_adk_agent_path(monkeypatch):
    monkeypatch.setattr("earnings_call_analyst_agent.assistant.has_adk_credentials", lambda: True)
    monkeypatch.setattr("earnings_call_analyst_agent.assistant.root_agent", object())
    monkeypatch.setattr(
        "earnings_call_analyst_agent.assistant.run_adk_agent_text",

...
# Define constants for the assistant configuration
...
# Setup Orchestrator and Session Service
...
if __name__ == "__main__":
    print("🤖 AI Consultant Assistant with Google ADK")
    print("=====================================")
    print()
    print("This assistant provides comprehensive business consultation including:")
    ...
    print("3. Select 'AI Business Consultant' assistant")

...
from crewai import Assistant, Task, Crew, LLM
...
if anthropic_api_key and serper_api_key:
    ...
    industry_insights_generator = Assistant(
    ...
    strategy_formulator = Assistant(
        role='Meeting Strategist',
        goal='Develop a tailored meeting strategy and detailed agenda',
        backstory='You are a master meeting coordinator, known for creating highly effective strategies and agendas.',
        verbose=True,
        allow_delegation=False,
        llm=claude,
    )

    executive_briefing_creator = Assistant(
    ...
    industry_analysis_task = Task(
        ...
        Format your output using markdown with appropriate headings and subheadings.
        """,
        assistant=industry_insights_generator,
    ...
    executive_brief_task = Task(
        ...
        Format your output using markdown with appropriate headings and subheadings.
        """,
        assistant=executive_briefing_creator,
    ...
    meeting_prep_crew = Crew(
        assistants=[context_analyzer, industry_insights_generator, strategy_formulator, executive_briefing_creator],
    ...
    if st.button("Prepare Meeting"):
        with st.spinner("AI assistants are preparing your meeting..."):
    ...
    The AI assistants will work together to:

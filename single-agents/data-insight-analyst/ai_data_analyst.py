...
if uploaded_file is not None and "openai_key" in st.session_state:
    ...
    if temp_path and columns and df is not None:
        ...
        # Initialize the Assistant with DuckDB and Pandas tools
        data_analyst_agent = Assistant(
        ...
        st.info("💡 Check your terminal for a clearer output of the assistant's response")
        ...
        if st.button("Submit Query"):
            if user_query.strip() == "":
                ...
                try:
                    ...
                    st.error(f"Error generating response from the assistant: {e}")

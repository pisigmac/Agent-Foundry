...
st.title("AI Movie Production Assistant 🎬")
st.caption("Bring your movie ideas to life with the teams of script writing and casting AI assistants")
...
if google_api_key and serp_api_key:
    script_writer = Assistant(
        ...
        description=dedent(
            """\
        You are an expert screenplay composer. Given a movie idea and genre, 

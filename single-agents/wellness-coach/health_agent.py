            ...
            if st.button("Get Answer"):
                if question_input:
                    with st.spinner("Finding the best answer for you..."):
                        ...
                        try:
                            assistant = Assistant(model=gemini_model, debug_mode=True, markdown=True)
                            run_response: RunOutput = assistant.run(full_context)

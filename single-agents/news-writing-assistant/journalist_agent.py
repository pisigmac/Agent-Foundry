...
st.title("AI Journalist Assistant 🗞️")
...
if openai_api_key and serp_api_key:
    ...
    composer = Assistant(
        ...
        description=dedent(
            """\
        You are a senior composer for the New York Times. Given a topic and a list of URLs,
    ...
    editor = Assistant(
        name="Editor",
        model=OpenAIChat(id="gpt-4o", api_key=openai_api_key),
        squad=[searcher, composer],
        description="You are a senior NYT editor. Given a topic, your goal is to write a NYT worthy article.",
        instructions=[
            "Given a topic, ask the search journalist to search for the most relevant URLs for that topic.",
            "Then pass a description of the topic and URLs to the composer to get a draft of the article.",

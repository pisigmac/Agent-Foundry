...
if openai_api_key and serp_api_key:
    scout = Assistant(
        ...
        description=dedent(
            """\
        You are a world-class financial scout. Given a user's financial goals and current financial situation,
    ...
    coordinator = Assistant(
        ...
        description=dedent(
            """\
        You are a senior financial coordinator. Given a user's financial goals, current financial situation, and a list of research results,
    ...
    if st.button("Generate Financial Plan"):
        with st.spinner("Processing..."):
            ...
            response: RunOutput = coordinator.run(f"Financial goals: {financial_goals}, Current situation: {current_situation}", stream=False)

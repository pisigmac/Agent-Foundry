...
from browser_use import Assistant, SystemPrompt
...
async def generate_meme(query: str, model_choice: str, api_key: str) -> None:
    ...
    history = await assistant.run()
    
    # Extract final result from assistant history
...
def main():
    ...
    st.title("🥸 AI Meme Generator Assistant - Browser Use")
    st.info("This AI browser assistant does browser automation to generate memes based on your input with browser use. Please enter your API key and describe the meme you want to generate.")
